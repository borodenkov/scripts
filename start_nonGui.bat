...
setlocal
set EXECUTE_ARGS=-n -t "SUDIR_Lite.jmx"
...
%JM_START% %JM_LAUNCH% %ARGS% %JVM_ARGS% -jar "%JMETER_SUDIR%ApacheJMeter.jar" %JMETER_CMD_LINE_ARGS% %EXECUTE_ARGS%
